...
def register_admin_handlers(app: Client):
    ...
    async def admin_panel(client: Client, message: Message):
        ...
        await message.reply_text(
            "⚙️ **Admin Control Panel**\n\nManage system toggles and settings below:",
            reply_markup=keyboard
        )

    # 2. Callback Query Handler for Admin Buttons
    @app.on_callback_query(filters.regex(r"^(toggle_limit|toggle_maint|admin_stats)$"))
    ...
    async def add_premium_cmd(client: Client, message: Message):
        ...
        try:
            ...
            await message.reply_text(f"✅ **Success!** User `{target_user}` has been granted Premium for **{days} days**.")
    ...
    async def ban_user_cmd(client: Client, message: Message):
        ...
        try:
            ...
            await message.reply_text(f"🚫 User `{target_user}` has been banned from using the bot.")
        except ValueError:
            await message.reply_text("❌ Invalid User ID.")

    # 6. Unban User Command
    ...
    async def unban_user_cmd(client: Client, message: Message):
        ...
        try:
            ...
            await message.reply_text(f"✅ User `{target_user}` has been unbanned.")
        except ValueError:
            await message.reply_text("❌ Invalid User ID.")
